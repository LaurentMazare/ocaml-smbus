...
external i2c_smbus_write_quick : fd -> int -> unit = "ml_i2c_smbus_write_quick"
external i2c_smbus_read_byte : fd -> int = "ml_i2c_smbus_read_byte"
external i2c_smbus_write_byte : fd -> int -> unit = "ml_i2c_smbus_write_byte"
external i2c_smbus_read_byte_data : fd -> int -> int = "ml_i2c_smbus_read_byte_data"
external i2c_smbus_write_byte_data : fd -> int -> int -> unit = "ml_i2c_smbus_write_byte_data"
external i2c_smbus_read_word_data : fd -> int -> int = "ml_i2c_smbus_read_word_data"
external i2c_smbus_write_word_data : fd -> int -> int -> unit = "ml_i2c_smbus_write_word_data"
...
external i2c_set_address : fd -> int -> bool -> unit = "ml_i2c_set_address"
